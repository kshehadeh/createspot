...
async function getRandomPublicSubmissions(limit: number = 12) {
...
export default async function WelcomePage() {
  ...
  return (
    <main className="flex h-[calc(100vh-var(--navbar-height))] flex-col overflow-hidden lg:flex-row">
      ...
      <div className="flex w-full flex-col justify-start gap-6 overflow-y-auto bg-background p-6 lg:w-[480px] lg:p-12">
        {/* Sign In Card */}
