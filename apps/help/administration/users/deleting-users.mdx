...
Admins can delete user accounts when necessary (e.g. abuse, spam, or at the user’s request). Deletion is a serious action and usually affects the user’s profile, portfolio, and submissions linked to exhibits or collections.
...
- **Exhibits** — If the user was a curator or featured artist, those references may break or be cleared. Fix exhibits as needed after deletion.
